...
Root folder contains all training scripts used for different fine-tuning configurations. Test.ipynb is a notebook used for creating task-predictions for each model configuration.
